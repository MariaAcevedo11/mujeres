...
<template>
  <div class="bg-linear-to-t from-purple-950 to-purple-700 min-h-screen">
    <div class="flex h-screen overflow-hidden">
      <!-- sidebar -->
      <!-- From Uiverse.io by icochran10 --> 
<ul class="w-64 flex flex-col gap-1 border-l border-gray-200 pl-1 mt-70">
...
<li
  ...
  >
    ...
    >
      ...
      <div class="font-semibold">Movies</div>
    </RouterLink>
  ...
  >
    ...
    >
      ...
      <div class="font-semibold">Actress</div>
    </RouterLink>
    <div
